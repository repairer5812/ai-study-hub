...
> 🗣️ **교수님 농담**: 강의 중 학생들에게 "플래그 변수 이름은 뭐라고 할까요?"라고 직접 물으시며 환한 미소로 소통하셨다. "자료구조는 항상 **공간과 시간의 효율성**을 고민해야 한다"고 재차 강조.
...
> 🗣️ **교수님 에피소드**: 한 학생에게 Big-O 복잡도를 물으신 뒤 다른 학생에게 "제가 특별히 애정을 갖고 설명했던, 우리의 **이상형 시간 복잡도**가 뭐죠?"라고 질문 → 정답은 $O(\log N)$.

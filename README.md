...
|------|---------|---------|----------------|
| 🤖 기계학습 | ✅ 1~7, 9~13주차 | ✅ 중간 5세트(150) · 기말 5세트(130) | ✅ 9~13주차 |
| 💻 딥러닝 | ✅ 1~10주차 + 예상문제·모범답안 | ✅ 중간 서술형 8세트 | ✅ 8주차 |
| 📊 자료구조 | ✅ 1~12차시 + 기말 INDEX | 중간 4세트 · 기말 준비 중 | ✅ 9~12차시 |
| 🗣️ 자연어 처리 | ✅ 1~9장 (N-gram·임베딩·RNN·Transformer·LLM·RAG·Agents) + 보충 2 | 🔒 준비 중 | 🔒 준비 중 |
| 🔒 AI 보안기술 | 🔒 자료 수집 예정 | 🔒 | 🔒 |

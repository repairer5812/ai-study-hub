...
// 9·10·11·12·13주차 각 1세트(각 20문항) + 전범위 종합 1세트(30문항) = 130문항
// 노트 기반 출제 → 스키마·정답범위 검증 + 정답분포 균형 완료. 종합세트는 label '전범위 종합'으로 🏆 표시.
...
export const FINAL_META = [
  {
    ...
    "title": "SET 9",
    "label": "9주차 밀도추정",
    "desc": "KDE·KNN·GMM·MLE (기말·난이도 상, 20문항)"
  },
  {
    "id": 110,
    "exam": "final",
    "title": "SET 10",
    "label": "10주차 클러스터링",
    "desc": "K-Means·GMM·EM·계층 (기말·난이도 상, 20문항)"
  },
  {
    "id": 111,
    "exam": "final",
  ...
  },
  {
    ...
    "title": "SET 12",
    "label": "12주차 매니폴드",
    "desc": "MDS·t-SNE·UMAP (기말·난이도 상, 20문항)"
  },
  {
    "id": 113,
    "exam": "final",
    "title": "SET 13",
    "label": "13주차 신경망",
    "desc": "Perceptron·Adaline·BCE·Softmax (기말·난이도 상, 20문항)"
  },
  {
    "id": 106,
    "exam": "final",

...
export const set5 = [
  ...
  },
  {
    ...
    detailed: "최단경로는 하나의 출발 정점에서 다른 정점까지 이르는 경로 중 간선 가중치(시간·비용·거리)의 합이 최소가 되는 경로를 찾는 문제다. 역 수만 따지면 모든 간선 가중치를 1로 두면 된다. 첫 보기는 (최소)신장트리 문제다.",
    source: "12차시 슬라이드 19"
  },
  {
    id: "DS_F5Q24",
...
export const set6 = [
  ...
  },
  {
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "Kruskal·Prim에서 여러 간선의 가중치가 같을 때(동률) 적용하는 우선순위 규칙으로 옳은 것은?",
    choices: [
      "알파벳이 앞서거나 숫자가 작은 정점을 잇는 간선을 우선 택한다",
      "알파벳이 뒤에 오거나 숫자가 큰 정점을 잇는 간선을 우선 택한다",
      "동률인 간선은 모두 동시에 트리에 함께 선택해 넣는다",
      "동률인 간선은 전부 버리고 다음 가중치로 넘어간다"
    ],
    answer: 0,
    brief: "동률이면 알파벳 앞·작은 숫자 정점 우선.",
    detailed: "가중치가 같을 경우 알파벳이 앞서거나 숫자가 작은 정점을 연결하는 간선을 우선적으로 선택한다. 답안의 일관성을 위한 디테일로, 이 우선순위를 놓치지 않도록 주의한다.",
    source: "12차시 슬라이드 11"
  },
  {
    id: "DS_F6Q22",
...
export const set8 = [
  ...
  },
  {
    ...
    answer: 3,
    brief: "출발점→목적지 가중치 합 최소 경로.",
    detailed: "최단경로는 하나의 출발 정점에서 다른 정점까지 이르는 경로 중 간선 가중치(시간·비용·거리)의 합이 최소가 되는 경로를 찾는 문제다. 역 수만 따지면 모든 간선 가중치를 1로 두면 된다. 첫 번째 보기는 (최소)신장트리 문제다.",
    source: "12차시 슬라이드 19"
  },
  {
    id: "DS_F8Q21",
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "Kruskal·Prim에서 여러 간선의 가중치가 같을 때(동률) 적용하는 우선순위 규칙은?",
    choices: [
      "알파벳이 앞서거나 숫자가 작은 정점 간선을 우선 선택한다",
      "알파벳이 뒤이거나 숫자가 큰 정점 간선을 우선 선택한다",
      "동률인 간선들을 한꺼번에 동시에 모두 선택한다",
      "동률인 경우 그 간선들을 모두 후보에서 버린다"
    ],
    answer: 0,
    brief: "동률이면 알파벳 앞·작은 숫자 정점 우선.",
    detailed: "가중치가 같을 경우 알파벳이 앞서거나 숫자가 작은 정점을 연결하는 간선을 우선적으로 선택한다. 답안의 일관성을 위한 디테일로, 이 우선순위를 놓치지 않아야 한다.",
    source: "12차시 슬라이드 11"
  },
  {
    id: "DS_F8Q22",

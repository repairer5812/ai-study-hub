...
export const SETS_META = [
  ...
  { id: 9, exam: "final", title: "SET 5", label: "9~14 종합평가", desc: "트리·히프·그래프·정렬·검색 9~14차시 종합 (서술형 대체)" },
];
...
export const set1 = [
  ...
  },
  {
    ...
    detailed: "이진 검색은 매 단계 탐색 범위가 절반으로 줄어든다. n = 2ᵏ에서 k = log₂ n이므로 O(log n)이다.",
    source: "3차시 § 5.3",
  },
  {
    id: "DS_S1Q8",
...
export const set6 = [
  ...
  },
  {
    ...
    "answer": 3,
    "brief": "레벨 i 최대 노드 = 2ⁱ⁻¹.",
    "detailed": "레벨 1은 2⁰=1개, 레벨 2는 2¹=2개, 레벨 3은 2²=4개로 레벨 i의 최대 노드 수는 2ⁱ⁻¹개다. 매 레벨마다 자식이 최대 2배로 늘기 때문이다.",
    "source": "9차시 §5 이진 트리 수학적 성질"
  },
  {
    "id": "DS_F6Q3",
    ...
    "answer": 1,
    "brief": "포화 이진 트리 노드 수 = 2ʰ − 1.",
    "detailed": "포화 이진 트리는 모든 레벨이 꽉 찬 트리다. 각 레벨 i의 노드 수(2ⁱ⁻¹)를 레벨 1부터 h까지 합하면 2⁰+2¹+...+2ʰ⁻¹ = 2ʰ − 1개가 된다. 한쪽으로만 치우친 편향 트리(높이 h)의 최소 노드 수는 h개다.",
  ...
  },
  {
    ...
    "answer": 2,
    "brief": "최소 높이 = ⌈log₂(n+1)⌉.",
    "detailed": "노드를 위 레벨부터 빈틈없이 꽉 채울 때 높이가 최소가 된다. 높이 h로 담을 수 있는 최대 노드가 2ʰ − 1 ≥ n 이어야 하므로, 최소 높이는 ⌈log₂(n+1)⌉이다. 이때 탐색이 O(log N)으로 가장 효율적이다.",
    "source": "9차시 §5 이진 트리 수학적 성질"
  },
  {
    id: "DS_F6Q5",
  ...
  },
  {
    ...
    answer: 0,
    brief: "nⁿ⁻² = 4⁴⁻² = 4² = 16.",
    detailed: "정점이 n개인 완전 그래프의 신장트리 개수는 nⁿ⁻²개다(케일리 공식). n=4이면 4⁴⁻² = 4² = 16개가 된다.",
    source: "12차시 슬라이드 7"
  },
  {
    id: "DS_F6Q20",
...
export const set8 = [
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "퀵 정렬의 평균 복잡도 유도에서 T(N) ≤ cN + 2·T(N/2)를 전개해 N/2ᵏ = 1이 될 때, k 값과 최종 시간 복잡도로 옳은 것은?",
    "choices": [
      "k = N, O(N²)",
      "k = log₂N, O(N log N)",
      "k = √N, O(N√N)",
    ...
    "answer": 1,
    "brief": "2ᵏ = N → k = log₂N → O(N log N).",
    "detailed": "전개하면 k·cN + 2ᵏ·T(N/2ᵏ)가 되고, 더 쪼갤 수 없어 N/2ᵏ=1인 시점에서 2ᵏ=N → k=log₂N이다. N번 비교가 log₂N단계 일어나므로 O(N log₂N)(로그 선형)이다.",
...
export const set9 = [
  // ===== 9차시: 트리 I (4문항) =====
  {
    ...
    type: "multiple_choice",
    difficulty: "hard",
    question: "다음 이진 트리를 전위(Preorder, V-L-R)로 탐색한 결과는? 루트는 A, A의 왼쪽 자식은 B, 오른쪽 자식은 C이다. B의 왼쪽 자식은 D, 오른쪽 자식은 E이며, C의 오른쪽 자식은 F이다. (D, E, F는 단말 노드)",
    choices: [
      "A, B, D, E, C, F",
      "D, B, E, A, C, F",
      "D, E, B, F, C, A",
    ...
    answer: 0,
    brief: "전위 V-L-R: 루트 먼저, 왼쪽 서브트리, 오른쪽 서브트리.",
    detailed: "전위 탐색은 루트(V)를 먼저 방문한 뒤 왼쪽(L), 오른쪽(R) 서브트리 순으로 내려간다. A 방문 후 왼쪽 서브트리(B를 방문하고 그 자식 D, E)를 처리하면 A, B, D, E가 되고, 이어 오른쪽 서브트리 C와 그 자식 F를 처리해 C, F가 붙는다. 따라서 A, B, D, E, C, F다. 두 번째는 중위(L-V-R), 세 번째는 후위(L-R-V), 네 번째는 레벨 순서에 가까운 오답이다.",
    source: "9차시 §7 이진 트리 탐색"
  },
  {
    id: "DS_S9Q2",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "이진 트리의 레벨 순서(Level Order) 탐색을 구현할 때, 같은 레벨의 옆 노드로 이동하기 위해 사용하는 보조 자료구조와 그 동작 방식으로 옳은 것은?",
    choices: [
      "스택을 써서 방문한 노드를 LIFO로 꺼내며 진행한다",
      "큐를 써서 방문한 노드의 자식을 넣고 FIFO로 꺼낸다",
      "우선순위 큐를 써서 값이 큰 노드부터 꺼내며 진행한다",
      "연결 리스트만으로 형제 링크를 따라 직접 이동한다"
    ],
    answer: 1,
    brief: "레벨 탐색 = 큐(FIFO): 자식을 enqueue, 먼저 들어온 것 dequeue.",
    detailed: "포인터는 부모에서 자식으로만 연결되어 같은 레벨의 옆 노드로 직접 갈 수 없다. 노드를 방문할 때 그 왼쪽·오른쪽 자식을 큐에 enqueue하고, 먼저 들어온 노드를 dequeue해 다시 방문하면(FIFO) 물리적 형제 링크 없이도 레벨 순서대로 방문된다. 스택은 깊이 우선(전위)에 대응하고, 레벨 탐색에 대소나 형제 링크는 쓰지 않는다.",
    source: "9차시 §7 레벨 탐색"
  },
  {
    id: "DS_S9Q3",
    set: 9,
    week: 9,
    topic: "쓰레드 이진트리 NULL 링크 수",
    type: "multiple_choice",
    difficulty: "medium",
    question: "노드가 7개인 이진 트리를 연결 리스트로 표현하면 전체 링크는 2n개다. 이 중 자식을 가리키지 않아 스레드로 재활용할 수 있는 NULL 링크의 개수는?",
    choices: [
      "6개",
      "7개",
      "8개",
    ...
    answer: 2,
    brief: "NULL 링크 = n+1 = 7+1 = 8개.",
    detailed: "노드 n개의 전체 링크는 2n개이고, 실제 자식을 가리키는 링크는 간선 수와 같은 n−1개다. 따라서 NULL 링크는 2n−(n−1)=n+1개다. n=7이면 8개가 된다. 이 n+1개의 NULL 링크를 중위 탐색의 선행자·후속자로 연결한 것이 스레드 이진 트리다.",
    source: "9차시 §9 쓰레드 이진 트리"
  },
  {
    id: "DS_S9Q4",
    ...
    type: "multiple_choice",
    difficulty: "hard",
    question: "빈 BST에 50, 30, 70, 20, 40을 순서대로 삽입했다. 이어서 35를 삽입하면 35는 어느 노드의 어느 자식 자리에 들어가는가? (BST 규칙: 왼쪽 < 루트 < 오른쪽)",
    choices: [
      "30의 오른쪽 자식 40의 왼쪽 자식",
      "30의 왼쪽 자식 20의 오른쪽 자식",
      "루트 50의 왼쪽 자식 자리",
      "70의 왼쪽 자식 자리"
    ],
    answer: 0,
    brief: "35는 50→왼쪽 30→오른쪽 40→왼쪽 자리에 삽입.",
    detailed: "삽입은 검색이 실패해 NULL에 닿는 자리에 노드를 단다. 35는 루트 50보다 작아 왼쪽(30)으로, 30보다 크므로 30의 오른쪽(40)으로, 40보다 작으므로 40의 왼쪽으로 내려간다. 40의 왼쪽은 비어 있으므로 35는 40의 왼쪽 자식이 된다. 즉 '30의 오른쪽 자식 40의 왼쪽 자식' 자리다.",
    source: "9차시 §10 BST 삽입"
  },
  ...
  // ===== 10차시: 힙과 우선순위 큐 (4문항) =====
  {
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "힙을 1-인덱스 배열로 저장할 때(부모 ⌊i/2⌋, 왼쪽 자식 2i, 오른쪽 자식 2i+1) 인덱스 5에 있는 노드의 왼쪽 자식과 오른쪽 자식 인덱스를 바르게 짝지은 것은?",
    choices: [
      "왼쪽 11, 오른쪽 12",
      "왼쪽 10, 오른쪽 11",
      "왼쪽 6, 오른쪽 7",
    ...
    answer: 1,
    brief: "1-인덱스: 왼쪽 2i=10, 오른쪽 2i+1=11.",
    detailed: "힙은 1-인덱스 배열이므로 인덱스 i의 왼쪽 자식은 2i, 오른쪽 자식은 2i+1이다. i=5이면 왼쪽은 2×5=10, 오른쪽은 2×5+1=11이다. 9차시의 0-인덱스 트리 공식(2i+1, 2i+2)과 혼동하면 안 된다.",
    source: "10차시 §3 배열 인덱스 공식"
  },
  {
    id: "DS_S9Q6",
    set: 9,
    week: 10,
    topic: "Max Heap 삽입 트레이싱",
    type: "multiple_choice",
    difficulty: "hard",
    question: "Max Heap이 배열 [20, 15, 5, 14, 10, 2](1-인덱스)로 저장되어 있다. 여기에 21을 삽입하면 Up-heap 후 최종 배열은? (마지막 빈자리에 넣고 부모와 비교해 위로 올림)",
    choices: [
      "[21, 15, 20, 14, 10, 2, 5]",
      "[20, 15, 5, 14, 10, 2, 21]",
      "[21, 20, 15, 14, 10, 5, 2]",
    ...
    answer: 0,
    brief: "21을 [7]에 넣고 부모 5, 그 다음 20과 교환해 루트로.",
    detailed: "삽입은 값과 무관하게 완전 이진 트리를 유지하도록 마지막 빈자리 [7]에 21을 넣는다. [7]의 부모는 ⌊7/2⌋=3번(값 5)이고 21>5라 교환, 그 다음 [3]의 부모 [1](값 20)과 비교해 21>20이라 다시 교환되어 21이 루트가 된다. 결과는 [21, 15, 20, 14, 10, 2, 5]다. 두 번째는 교환을 안 한 오답이다.",
    source: "10차시 §4 삽입(Up-heap)"
  },
  {
    id: "DS_S9Q7",
    set: 9,
    week: 10,
    topic: "Down-heap 자식 선택 원리",
    type: "multiple_choice",
    difficulty: "medium",
    question: "Max Heap에서 루트를 삭제한 뒤 마지막 노드를 루트로 올려 Down-heap을 수행한다. 올라온 노드를 왼쪽·오른쪽 자식 중 어느 쪽과 교환해야 하며 그 이유로 옳은 것은?",
    choices: [
      "왼쪽 자식과 교환한다. 항상 왼쪽이 먼저 채워지기 때문이다",
      "더 작은 자식과 교환한다. 작은 값을 위로 올려야 하기 때문이다",
      "더 큰 자식과 교환한다. 그 자식이 서브트리에서 가장 크기 때문이다",
      "두 자식 모두와 한 번씩 교환해 평균을 맞춰야 하기 때문이다"
    ],
    answer: 2,
    brief: "더 큰 자식과 교환: 그 값이 해당 서브트리 최댓값이라 부모 ≥ 자식 유지.",
    detailed: "Down-heap에서는 왼쪽·오른쪽 자식 중 더 큰 값과 교환한다. 두 자식 중 큰 쪽이 그 서브트리에서 가장 큰 값이므로, 그것을 부모 자리에 올려야 'Max Heap의 부모 ≥ 자식' 규칙이 유지된다. 작은 자식과 바꾸면 올라간 자식이 다른 형제보다 작아져 힙 규칙이 깨진다.",
    source: "10차시 §5 삭제(Down-heap)"
  },
  {
    id: "DS_S9Q8",
    set: 9,
    week: 10,
    topic: "BST vs Heap 비교",
    type: "multiple_choice",
    difficulty: "hard",
    question: "같은 노드 집합을 BST와 Max Heap으로 각각 구성했을 때의 차이로 옳지 않은 것은?",
    choices: [
      "BST는 삽입 시 값을 비교해 좌/우를 결정하지만 힙은 빈자리부터 채운다",
      "BST의 중위 탐색은 오름차순이지만 힙은 정렬 의미가 없다",
      "최댓값을 Max Heap은 루트라 O(1)에 알지만 BST는 맨 오른쪽까지 따라간다",
      "BST와 힙 모두 형제 노드 간 좌우 대소가 항상 정해져 있다"
    ],
    answer: 3,
    brief: "힙은 형제 간 좌우 대소가 정해지지 않음 → 틀린 설명.",
    detailed: "네 번째가 틀렸다. 힙은 부모-자식 간 대소만 정해질 뿐 형제(좌·우) 간 대소는 정해지지 않는다. 이것이 '중위 탐색하면 정렬되는' BST와의 결정적 차이다. 나머지 셋은 모두 옳은 비교다: BST는 값 비교로 좌우를 정하고 힙은 자리부터 채우며, BST 중위는 오름차순, 힙 최댓값은 루트라 O(1)이다.",
    source: "10차시 §6 BST vs Heap"
  },
  ...
  // ===== 11차시: 그래프 표현과 탐색 (4문항) =====
  {
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "정점이 6개인 무방향 완전 그래프와 방향 완전 그래프의 최대 간선 수를 바르게 짝지은 것은? (무방향 n(n−1)/2, 방향 n(n−1))",
    choices: [
      "무방향 15개, 방향 30개",
      "무방향 30개, 방향 15개",
      "무방향 12개, 방향 24개",
    ...
    answer: 0,
    brief: "무방향 6·5/2=15, 방향 6·5=30.",
    detailed: "완전 그래프의 최대 간선 수는 무방향이 n(n−1)/2, 방향이 n(n−1)이다. n=6이면 무방향은 6×5/2=15개, 방향은 6×5=30개다. 방향 그래프는 같은 두 정점 사이를 양방향으로 따로 세므로 무방향의 2배가 된다.",
    source: "11차시 §5 완전 그래프"
  },
  {
    id: "DS_S9Q10",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "어떤 연결된 무방향 그래프의 네 정점 차수가 각각 5, 3, 3, 3이다. 이 그래프에 모든 간선을 한 번씩 지나는 오일러 경로가 존재하는지와 그 근거로 옳은 것은?",
    choices: [
      "존재한다. 모든 정점이 연결되어 있기만 하면 충분하기 때문이다",
      "존재하지 않는다. 홀수 차수 정점이 4개로 2개를 초과하기 때문이다",
      "존재한다. 차수의 합이 짝수(14)이기 때문이다",
      "존재하지 않는다. 정점 수가 간선 수보다 적기 때문이다"
    ],
    answer: 1,
    brief: "홀수 차수 정점 4개 > 2개 → 오일러 경로 없음.",
    detailed: "오일러 경로 존재 조건은 (1) 모든 정점이 연결, (2) 차수가 홀수인 정점이 2개 이하다. 차수 5,3,3,3은 모두 홀수라 홀수 차수 정점이 4개이므로 조건을 위배해 오일러 경로가 존재하지 않는다. 이것이 쾨니히스베르크 다리 문제의 결론이다. 차수 합이 짝수인 것은 모든 그래프에 항상 성립하므로 근거가 되지 못한다.",
    source: "11차시 §3 오일러 정리"
  },
  {
    id: "DS_S9Q11",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "정점이 N개인 그래프를 인접 행렬로 표현할 때의 성질로 옳은 것은?",
    choices: [
      "공간 복잡도가 O(N)이며 간선이 적으면 더 줄어든다",
      "공간 복잡도가 O(N²)이고 무방향 그래프면 대각선 기준 대칭이다",
      "두 정점의 인접 여부 확인에 리스트 순회가 필요해 O(N)이 든다",
      "방향 그래프에서는 항상 대각선 기준으로 대칭이 된다"
    ],
    answer: 1,
    brief: "인접 행렬 공간 O(N²), 무방향이면 대칭.",
    detailed: "인접 행렬은 N×N 2차원 배열이라 간선 수와 무관하게 공간 복잡도가 O(N²)이다. 무방향 그래프는 (i,j)와 (j,i)가 같으므로 대각선 기준으로 대칭이 된다. 인접 여부는 배열을 직접 접근해 O(1)에 확인되며(리스트 순회는 인접 리스트의 특성), 대칭은 방향 그래프가 아니라 무방향 그래프의 성질이다.",
    source: "11차시 §7 인접 행렬"
  },
  {
    id: "DS_S9Q12",
    set: 9,
    week: 11,
    topic: "DFS/BFS 자료구조 대응",
    type: "multiple_choice",
    difficulty: "basic",
    question: "그래프 탐색 DFS와 BFS가 각각 사용하는 보조 자료구조와 대응하는 트리 탐색을 바르게 짝지은 것은?",
    choices: [
      "DFS = 큐 = 트리 레벨 탐색, BFS = 스택 = 트리 전위 탐색",
      "DFS = 스택 = 트리 전위 탐색, BFS = 큐 = 트리 레벨 탐색",
      "DFS = 스택 = 트리 후위 탐색, BFS = 큐 = 트리 중위 탐색",
      "DFS = 우선순위 큐 = 트리 중위, BFS = 큐 = 트리 레벨"
    ],
    answer: 1,
    brief: "DFS=스택=전위, BFS=큐=레벨.",
    detailed: "DFS는 막히면 되돌아와야 하므로 스택(LIFO)을 쓰고 트리의 전위 탐색에 대응한다. BFS는 가까운 정점을 먼저 방문하므로 큐(FIFO)를 쓰고 트리의 레벨 탐색에 대응한다. 이 1:1 대응(DFS=스택=전위, BFS=큐=레벨)이 핵심이다.",
    source: "11차시 §9 그래프 탐색"
  },
  ...
  // ===== 12차시: 최단경로와 신장트리 (5문항) =====
  {
    ...
    type: "multiple_choice",
    difficulty: "basic",
    question: "정점이 n개인 연결 그래프 G의 신장트리(Spanning Tree) G'가 반드시 만족해야 하는 조건으로 옳은 것은?",
    choices: [
      "G의 모든 정점을 포함하고 연결되며 간선이 n−1개다",
      "G의 모든 간선을 포함하고 사이클이 정확히 1개 있다",
      "정점 일부만 골라 간선 가중치 합을 최대로 만든다",
      "간선이 n개여서 정점을 한 바퀴 도는 사이클을 이룬다"
    ],
    answer: 0,
    brief: "모든 정점 포함 + 연결 + 간선 n−1 → 사이클 없음.",
    detailed: "신장트리는 (1) 원래 그래프의 모든 정점을 포함(V(G')=V(G)), (2) 연결 그래프, (3) 간선 수가 n−1개라는 세 조건을 모두 만족한다. 간선이 정점보다 1개 적으므로 사이클이 없다. 가중치 합 최소는 최소신장트리(MCST)의 조건이고, 간선이 n개이면 사이클이 생긴다.",
    source: "12차시 §2 신장트리"
  },
  {
    id: "DS_S9Q14",
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "정점이 5개인 완전 그래프가 가질 수 있는 서로 다른 신장트리의 개수는? (완전 그래프 신장트리 개수 = nⁿ⁻²)",
    choices: [
      "16개",
      "25개",
      "125개",
    ...
    answer: 2,
    brief: "nⁿ⁻² = 5³ = 125개.",
    detailed: "정점이 n개인 완전 그래프의 서로 다른 신장트리 개수는 케일리 공식 nⁿ⁻²이다. n=5이면 5⁵⁻²=5³=125개다. 참고로 n=4일 때는 4²=16개가 된다(첫 번째 보기는 n=4의 값이라 오답).",
    source: "12차시 §2 신장트리 개수"
  },
  {
    id: "DS_S9Q15",
    set: 9,
    week: 12,
    topic: "Kruskal 가중치 합 계산",
    type: "multiple_choice",
    difficulty: "hard",
    question: "정점 7개 그래프에 Kruskal을 적용한다. 간선을 가중치 오름차순으로 보면 (0,5)=10, (2,3)=12, (1,6)=14, (1,2)=16, (3,6)=18, (3,4)=22, (4,6)=24, (4,5)=25, (0,1)=28이다. 작은 것부터 선택하되 사이클이 생기는 간선은 버린다면, 완성된 최소신장트리의 가중치 합은?",
    choices: [
      "89",
      "99",
      "117",
    ...
    answer: 1,
    brief: "선택: 10+12+14+16+22+25 = 99 ((3,6)·(4,6)은 사이클로 버림).",
    detailed: "오름차순으로 선택하면 (0,5)10, (2,3)12, (1,6)14, (1,2)16까지 채택된다. 다음 (3,6)18은 이미 연결된 정점들을 다시 이어 사이클을 만들므로 버린다. (3,4)22 채택, (4,6)24는 또 사이클이라 버린다. (4,5)25를 채택하면 정점 7개가 모두 연결되어 간선 n−1=6개가 완성된다. 합은 10+12+14+16+22+25=99다.",
    source: "12차시 §3 Kruskal"
  },
  {
    id: "DS_S9Q16",
    set: 9,
    week: 12,
    topic: "Kruskal vs Prim 변별",
    type: "multiple_choice",
    difficulty: "medium",
    question: "최소신장트리를 구하는 Kruskal과 Prim 알고리즘의 차이로 옳은 것은?",
    choices: [
      "Kruskal은 정점 기반이고 Prim은 간선 기반으로 동작한다",
      "Kruskal은 간선 기반이고 Prim은 정점 기반으로 트리를 키운다",
      "Kruskal만 그리디이고 Prim은 모든 경우를 완전 탐색한다",
      "둘은 항상 서로 다른 가중치 합의 신장트리를 만든다"
    ],
    answer: 1,
    brief: "Kruskal=간선 기반(가중치 정렬), Prim=정점 기반(트리 확장).",
    detailed: "Kruskal은 모든 간선을 가중치 오름차순으로 정렬해 작은 것부터 보며 사이클이면 버리는 '간선 기반'이고, Prim은 시작 정점에서 트리에 인접한 최소 간선의 정점을 하나씩 추가하는 '정점 기반'이다. 둘 다 그리디로 동작해 동일한 최소 가중치 합(Global Minimum)을 보장한다. 첫 번째는 둘을 바꿔 설명한 오답이다.",
    source: "12차시 §3 Kruskal vs Prim"
  },
  {
    id: "DS_S9Q17",
    set: 9,
    week: 12,
    topic: "Dijkstra Relaxation 트레이싱",
    type: "multiple_choice",
    difficulty: "hard",
    question: "Dijkstra로 BOST에서 최단거리를 구한다. 초기 distance는 CHI=1500, NY=250, 나머지는 ∞다. NY로의 간선 비용이 250이고 NY→CHI 간선 비용이 1000일 때, 미방문 중 최소인 NY를 먼저 확정한 직후 CHI의 distance는 어떻게 갱신되는가? (Relaxation: distance[w]=min(distance[w], distance[u]+cost[u][w]))",
    choices: [
      "1500 그대로 유지된다 (NY 경유가 더 길어서)",
      "1250으로 줄어든다 (250+1000 < 1500)",
      "1000으로 줄어든다 (NY→CHI 간선 비용만 반영)",
      "750으로 줄어든다 (1000−250)"
    ],
    answer: 1,
    brief: "min(1500, 250+1000)=1250으로 갱신.",
    detailed: "Dijkstra는 미방문 중 distance가 최소인 정점(NY=250)을 먼저 확정하고, 그 정점을 경유하는 이웃의 거리를 갱신한다. CHI는 직접 1500이지만 NY를 경유하면 distance[NY]+cost[NY][CHI]=250+1000=1250으로 더 짧다. 따라서 min(1500, 1250)=1250으로 줄어든다. '돌아가더라도 합이 작으면 우회'하는 원리다.",
    source: "12차시 §4 Dijkstra"
  },
  ...
  // ===== 13차시: 정렬 (6문항) =====
  {
    ...
    type: "multiple_choice",
    difficulty: "basic",
    question: "두 변수 A, B의 값을 서로 맞바꾸는 Swap을 임시 변수 temp로 수행할 때, 발생하는 데이터 이동(저장) 횟수는?",
    choices: [
      "1번",
      "2번",
      "3번",
    ...
    answer: 2,
    brief: "Swap = 이동 3번 (temp=A, A=B, B=temp).",
    detailed: "두 값을 맞바꾸려면 임시 변수가 반드시 필요하며 temp=A, A=B, B=temp의 세 번 저장이 일어난다. 따라서 Swap 1회는 이동 3번이다. 선택 정렬은 단계마다 1번 Swap하므로 총 이동이 3(N−1)이 되는 식으로 이 사실을 활용한다.",
    source: "13차시 §1 성능 평가"
  },
  {
    id: "DS_S9Q19",
    ...
    type: "multiple_choice",
    difficulty: "hard",
    question: "선택 정렬의 총 연산이 비교 N(N−1)/2 + 이동 3(N−1)로 주어질 때, 원소가 10개(N=10)이면 총 연산 횟수는?",
    choices: [
      "45",
      "63",
      "72",
    ...
    answer: 2,
    brief: "비교 45 + 이동 27 = 72.",
    detailed: "비교 횟수는 N(N−1)/2 = 10×9/2 = 45번이고, 이동 횟수는 단계마다 1번 Swap(3 이동)을 N−1번 하므로 3×(10−1)=27번이다. 합하면 45+27=72다. 빅오로는 최고차항만 보아 O(N²)이지만, 정확한 연산 수를 물을 때는 두 항을 모두 더한다.",
    source: "13차시 §2 선택 정렬"
  },
  {
    id: "DS_S9Q20",
    ...
    type: "multiple_choice",
    difficulty: "hard",
    question: "퀵 정렬이 평균 O(N log N)임에도 최악에 O(N²)으로 떨어지는 입력 조건과 그 이유로 옳은 것은?",
    choices: [
      "피벗이 매번 최소 또는 최대값으로 뽑혀 1개와 N−1개로 분할될 때",
      "피벗이 매번 정확히 중간값으로 뽑혀 절반씩 나뉠 때",
      "데이터가 모두 서로 다른 값으로 무작위 배치되어 있을 때",
      "재귀를 쓰지 않고 반복문만으로 구현했을 때"
    ],
    answer: 0,
    brief: "피벗이 최소/최대로 뽑혀 1:(N−1) 분할되면 O(N²).",
    detailed: "퀵 정렬은 피벗을 기준으로 둘로 분할해 정복한다. 그런데 피벗이 매번 최소 또는 최대값으로 뽑히면(예: 이미 정렬된 데이터에서 맨 앞을 피벗으로) 한쪽이 1개, 다른 쪽이 N−1개로 쪼개져 분할의 이점을 잃고 선택·버블처럼 O(N²)이 된다. 방지책은 중간값(median)을 피벗으로 고르는 것이다. 중간값 피벗은 오히려 최선의 균등 분할이다.",
    source: "13차시 §3 퀵 정렬"
  },
  {
    id: "DS_S9Q21",
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "삽입 정렬의 최선(Best)·최악(Worst) 시간 복잡도와 그 조건을 바르게 짝지은 것은?",
    choices: [
      "최선 O(N²)(이미 정렬), 최악 O(N log N)(역순)",
      "최선 O(N)(이미 정렬), 최악 O(N²)(역순)",
      "최선 O(log N)(이미 정렬), 최악 O(N)(역순)",
      "최선과 최악 모두 항상 O(N²)으로 동일하다"
    ],
    answer: 1,
    brief: "삽입: 최선 O(N)(거의 정렬), 최악 O(N²)(역순).",
    detailed: "삽입 정렬은 정렬된 그룹에 다음 원소를 끼워넣는다. 이미 정렬된 데이터라면 앞 값과 1번만 비교하고 끝나 전체 O(N)이 되어 거의 정렬된 데이터에 가장 효율적이다. 반대로 역순이면 매번 앞쪽 전체를 밀어야 해 O(N²)이 된다.",
    source: "13차시 §2 삽입 정렬"
  },
  {
    id: "DS_S9Q22",
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "힙 정렬(Heap Sort)에 대한 설명으로 옳은 것은?",
    choices: [
      "평균은 O(N log N)이지만 최악은 O(N²)으로 떨어진다",
      "힙은 편향 이진 트리이므로 추가 공간이 O(N) 필요하다",
      "힙은 완전 이진 트리이며 평균과 최악이 모두 O(N log N)이다",
      "비교를 하지 않고 정렬하므로 O(d·N)에 끝난다"
    ],
    answer: 2,
    brief: "힙=완전 이진 트리, 평균=최악 O(N log N).",
    detailed: "힙 정렬은 완전 이진 트리인 힙에서 루트(최댓값)를 떼어 뒤로 보내고 Down-heap으로 재구성하기를 N번 반복한다. 트리 높이가 log₂N이라 N회 재구성으로 평균과 최악이 모두 O(N log N)이다. 퀵 정렬처럼 최악에 O(N²)으로 떨어지지 않고, 추가 공간도 O(1)이다. 비교 없이 정렬하는 것은 기수 정렬이다.",
    source: "13차시 §3 힙 정렬, §5 비교표"
  },
  {
    id: "DS_S9Q23",
    set: 9,
    ...
    choices: [
      "값을 서로 비교하며 자리를 바꾸는 비교 기반 정렬이다",
      "비교 없이 자리수별 버킷(큐)에 넣고 빼며 O(d·N)에 정렬한다",
      "분할 정복으로 동작하며 외부 정렬에 주로 쓰인다",
      "실수·한글·한자를 포함한 모든 자료형에 적용 가능하다"
    ],
    answer: 1,
    brief: "기수 정렬 = 비교 없는 유일 정렬, 버킷(큐)·O(d·N).",
    detailed: "기수 정렬은 값을 비교하지 않고 자리수(1의 자리, 10의 자리…)별로 버킷에 분배했다 모으기를 반복하는 유일한 비교 없는 정렬이다. 버킷은 선입선출이라 큐로 구현하며(10진법이면 큐 10개), 시간은 자리수 d에 대해 O(d·N)이다. 분할 정복·외부 정렬은 머지 정렬, 모든 자료형 적용은 기수 정렬의 한계(동일 길이 숫자·단순 알파벳만)에 어긋난다.",
    source: "13차시 §4 기수 정렬"
  },
  ...
  // ===== 14차시: 검색 (7문항) =====
  {
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "정렬된 N개 데이터에서 이진 검색을 할 때 비교 대상이 N → N/2 → N/4 → … 로 반씩 줄어든다. N=2ᵏ라 할 때 데이터가 1개가 될 때까지의 반복 횟수와 그로부터 나오는 시간 복잡도는?",
    choices: [
      "반복 N번, O(N)",
      "반복 N/2번, O(N)",
      "반복 k=log₂N번, O(log N)",
    ...
    answer: 2,
    brief: "2ᵏ→2⁰까지 k번 반복, k=log₂N → O(log N).",
    detailed: "비교 대상이 2ᵏ → 2ᵏ⁻¹ → … → 2⁰으로 매번 절반이 되며, 1개가 될 때까지 k번 반복한다. N=2ᵏ의 양변에 밑이 2인 로그를 취하면 k=log₂N이므로 반복 횟수가 log₂N이고 시간 복잡도는 O(log N)이다. 이진 검색은 반드시 정렬된 데이터에서만 쓸 수 있다.",
    source: "14차시 §2 이진 검색"
  },
  {
    id: "DS_S9Q25",
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "해시 테이블의 적재밀도(loading density)는 '저장된 항목 수 ÷ 버킷 수 = n/M'으로 정의된다. 버킷이 7개인 테이블에 항목 5개가 저장되어 있을 때 적재밀도와 그 의미로 옳은 것은?",
    choices: [
      "5/7 ≈ 0.71, 1에 가까울수록 충돌·오버플로우 가능성이 커진다",
      "7/5 = 1.4, 값이 클수록 빈 버킷이 많아 안전하다",
      "5×7 = 35, 곱이 클수록 검색이 빨라진다",
      "7−5 = 2, 차이가 클수록 충돌이 자주 발생한다"
    ],
    answer: 0,
    brief: "적재밀도 n/M = 5/7 ≈ 0.71, 1에 가까울수록 충돌↑.",
    detailed: "적재밀도는 저장 항목 수 n을 버킷 수 M으로 나눈 값으로 5/7 ≈ 0.71이다. 적재밀도가 1에 가까울수록 테이블이 차 있어 충돌과 오버플로우 가능성이 커진다. 정의가 n/M이므로 곱이나 차로 계산하는 보기들은 모두 틀렸다.",
    source: "14차시 §3 해싱 용어"
  },
  {
    id: "DS_S9Q26",
    set: 9,
    week: 14,
    topic: "Linear Probing 트레이싱",
    type: "multiple_choice",
    difficulty: "hard",
    question: "해시함수 h(k)=k mod 7, 충돌 시 선형 조사법(Linear Probing: h, h+1, h+2 …)으로 8, 1, 9, 6, 13을 순서대로 삽입한다. 마지막 키 13이 최종 저장되는 버킷 번호는? (앞서 8→1, 1→2, 9→3, 6→6에 저장됨)",
    choices: [
      "0번",
      "3번",
      "5번",
    ...
    answer: 0,
    brief: "13 mod 7=6 충돌 → (6+1) mod 7=0에 저장.",
    detailed: "13 mod 7 = 6인데 6번 버킷은 이미 6이 차지하고 있어 충돌이다. 선형 조사법은 다음 칸을 보므로 (6+1) mod 7 = 0번을 조사하고, 0번이 비어 있으므로 13은 0번 버킷에 저장된다. 테이블 끝(6번)을 넘으면 처음(0번)으로 되돌아오는 점에 주의한다.",
    source: "14차시 §3 Linear Probing"
  },
  {
    id: "DS_S9Q27",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "해싱의 오버플로우 해결 방법에 대한 설명으로 옳지 않은 것은?",
    choices: [
      "Linear Probing은 h(k), h(k)+1, h(k)+2 …로 한 칸씩 옮겨 빈자리를 찾는다",
      "Quadratic Probing은 h(k), h(k)+1, h(k)+4 …로 제곱 간격으로 조사한다",
      "Double Hashing은 별개의 해시함수로 보폭(step)을 정해 이동한다",
      "Chaining은 각 버킷에 고정된 슬롯 수를 두고 그 안에서만 해결한다"
    ],
    answer: 3,
    brief: "Chaining은 연결 리스트라 고정 슬롯이 없음 → 틀린 설명.",
    detailed: "네 번째가 틀렸다. Chaining(체이닝)은 각 버킷에 연결 리스트를 달아 오버플로우를 해결하므로 고정된 슬롯 수에 얽매이지 않고 노드를 계속 이어붙인다. 나머지는 옳다: Linear는 +1씩, Quadratic은 +1, +4 …(1², 2² …)로 제곱 간격, Double Hashing은 두 번째 해시함수로 보폭(step=C−(k mod C))을 정한다.",
    source: "14차시 §3 오버플로우 해결 4종"
  },
  {
    id: "DS_S9Q28",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "hard",
    question: "BST에서 서브트리를 2개 모두 가진 노드를 삭제할 때(CASE 3), 그 자리에 가져와야 하는 노드로 옳은 것은?",
    choices: [
      "왼쪽 서브트리의 최솟값 또는 오른쪽 서브트리의 최댓값",
      "왼쪽 서브트리의 최댓값 또는 오른쪽 서브트리의 최솟값",
      "트리 전체의 최댓값을 항상 가져온다",
      "삭제 노드의 부모 노드를 끌어내려 채운다"
    ],
    answer: 1,
    brief: "왼쪽 서브트리 최댓값 또는 오른쪽 서브트리 최솟값.",
    detailed: "자식이 2개인 노드를 삭제하면 BST 정렬 성질(좌 ≤ 루트 ≤ 우)을 유지하도록 '삭제 노드와 값이 가장 비슷한' 노드를 가져온다. 그것은 왼쪽 서브트리의 최댓값(직전 선행자) 또는 오른쪽 서브트리의 최솟값(직후 후속자)이다. 첫 번째 보기는 좌·우를 반대로 적은 오답이다(왼쪽에서 최솟값을 가져오면 정렬이 깨진다).",
    source: "14차시 §4 BST 삭제 3 CASE"
  },
  {
    id: "DS_S9Q29",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "hard",
    question: "빈 AVL 트리에 10, 20, 30을 순서대로 삽입한다. 30을 삽입한 직후 어느 노드의 균형이 깨지며(BF가 범위를 벗어남) 어떤 회전이 필요한가? (BF = h_L − h_R, 정상 범위는 −1, 0, +1)",
    choices: [
      "노드 10의 BF가 −2가 되어 RR 회전(왼쪽 회전)이 필요하다",
      "노드 30의 BF가 +2가 되어 LL 회전(오른쪽 회전)이 필요하다",
      "노드 20의 BF가 +2가 되어 LR 회전이 필요하다",
      "어떤 노드도 균형이 깨지지 않아 회전이 필요 없다"
    ],
    answer: 0,
    brief: "10이 오른쪽-오른쪽으로 길어져 BF=−2 → RR 회전.",
    detailed: "10을 루트로 두고 20이 오른쪽, 30이 20의 오른쪽에 붙으면 루트 10의 오른쪽 높이가 2, 왼쪽 높이가 0이라 BF=0−2=−2로 범위를 벗어난다. 새 노드 30이 불균형 노드 10의 '오른쪽의 오른쪽'에 삽입된 경우이므로 RR 유형이고 왼쪽 회전(rotate_RR)으로 20을 새 루트로 만들어 균형을 맞춘다.",
    source: "14차시 §5 AVL 회전 4종"
  },
  {
    id: "DS_S9Q30",
    set: 9,
    ...
    type: "multiple_choice",
    difficulty: "medium",
    question: "B-트리를 개선한 B+트리의 특징으로 옳은 것은?",
    choices: [
      "모든 내부 노드와 단말 노드에 데이터를 중복 저장한다",
      "데이터는 leaf에만 두고 leaf끼리 연결 리스트로 잇는다",
      "단말 노드가 서로 다른 레벨에 있어도 무방하다",
      "키 검색은 빠르나 범위 검색은 B-트리보다 느리다"
    ],
    answer: 1,
    brief: "B+트리: 데이터는 leaf에만, leaf끼리 Linked list 연결.",
    detailed: "B+트리는 오직 단말(leaf) 노드에만 데이터를 저장하고, 내부 노드에는 자식 포인터(인덱스 키)만 둔다. 또한 leaf 노드끼리 연결 리스트로 이어져 있어 순차 접근과 범위 검색이 빠르다. 이는 모든 데이터를 순회하려면 모든 노드를 방문해야 하는 B-트리의 비효율을 개선한 것이다. 따라서 범위 검색은 B-트리보다 빠르다.",
    source: "14차시 §6 B+트리"
  }
];

const ALL = [...set1, ...set2, ...set3, ...set4, ...set5, ...set6, ...set7, ...set8, ...set9];

export const META = {
  id: "ds",
  title: "자료구조",
  subtitle: "1~14차시 · 정기고사 중간4·기말5세트 + 주차별 확인문제(9~14차시)",
  emoji: "📊",
  color: "#1E7E5F",
  available: true,
  hasExam: true,
  ...
  noteIndex: [
    ...
    { slug: "기말_INDEX_9to14차시", title: "📕 기말 INDEX — 트리·히프·그래프·정렬·검색(9~14차시)", week: 8 },
    ...
    { slug: "14차시_검색_완전정복", title: "🌟 14차시 — 검색·해싱·BST·AVL·B트리", week: 14 },
  ],
  weeklyExams: [
    ...
    { week: 14, slug: "14차시_검색_시험", title: "14차시 시험 — 검색·해싱·트리 (객관식 20)", count: 20 },
  ],
};

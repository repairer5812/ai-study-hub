...
export const set5 = [
  {
    ...
    "choices": [
      "모든 정점이 연결되어 있고 간선 수가 N−1개여서 사이클이 없다",
      "모든 정점의 차수가 2 이하이다",
      "간선 수가 N개 이상이다",
      "루트가 2개 이상 존재한다"
    ],
  ...
  },
  {
    ...
    "choices": [
      "노드의 차수(degree)는 그 노드의 조상 수이다",
      "단말 노드(leaf)는 차수가 0인 노드, 즉 자식이 없는 노드이다",
      "레벨(level)은 항상 0부터 시작한다",
      "트리의 높이는 노드의 최소 레벨이다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "choices": [
      ...
      "부모의 키가 항상 자식의 키보다 크다(좌우 무관)",
      "모든 레벨이 꽉 차 있어야 한다",
      "왼쪽 서브트리의 키가 항상 오른쪽 서브트리의 키보다 크다"
    ],
    "answer": 0,
    "brief": "L < Root < R.",
    "detailed": "BST는 임의의 노드에 대해 '왼쪽 서브트리의 모든 키값 < 루트 키값 < 오른쪽 서브트리의 모든 키값'을 만족한다. 이 규칙 덕분에 검색을 O(log N)으로 할 수 있다. ② 는 힙(Heap)의 성질이다.",
  ...
  },
  {
    ...
    "choices": [
      "부모 노드 값이 자식 노드 값보다 항상 크거나(또는 작거나) 한 완전 이진 트리",
      "왼쪽 서브트리 < 루트 < 오른쪽 서브트리 규칙을 만족하는 이진 트리",
      "모든 레벨이 빠짐없이 꽉 찬 포화 이진 트리만을 가리키는 용어",
      "NULL 링크를 재활용해 재귀 없이 순회하는 이진 트리"
    ],
    "answer": 0,
    "brief": "힙 = 부모-자식 대소 규칙을 만족하는 완전 이진 트리.",
    "detailed": "힙은 부모 노드의 원소 값이 자식 노드의 원소 값보다 항상 크거나(Max Heap) 작은(Min Heap) 완전 이진 트리다. ②는 BST, ④는 스레드 이진 트리 설명이다. 포화 이진 트리가 아니라 완전 이진 트리면 충분하다.",
    "source": "10차시 슬라이드 3"
  },
  {
    "id": "DS_F5Q8",
    ...
    "choices": [
      "Max Heap은 루트가 최솟값, Min Heap은 루트가 최댓값이다",
      "Max Heap은 부모 ≥ 자식이며 루트가 전체 최댓값이다",
      "Max Heap은 형제(좌·우) 노드 간에도 항상 왼쪽 < 오른쪽이 성립한다",
      "Min Heap은 완전 이진 트리일 필요가 없다"
    ],
    "answer": 1,
    "brief": "Max Heap: 부모 ≥ 자식, 루트 = 최댓값.",
    "detailed": "Max Heap은 부모 값이 자식보다 크거나 같아 루트에 전체 최댓값이 온다. Min Heap은 그 반대로 루트가 최솟값이다(①은 반대로 서술). 힙은 부모-자식 대소만 정해질 뿐 형제 간 대소는 정해지지 않으며(③ 오답), 둘 다 완전 이진 트리여야 한다(④ 오답).",
    "source": "10차시 슬라이드 3"
  },
  {
    "id": "DS_F5Q9",
    ...
    "type": "multiple_choice",
    "difficulty": "basic",
    "question": "교수님이 '힙을 만들 때 무조건 만들어야 한다'고 강조한 완전 이진 트리(Complete Binary Tree)의 조건은?",
    "choices": [
      "모든 레벨이 예외 없이 완전히 꽉 차 있어야 한다",
      "한쪽으로만 노드가 이어진 편향 구조여야 한다",
      "마지막 레벨을 제외한 모든 레벨이 꽉 차고, 마지막 레벨은 왼쪽부터 빈틈없이 채워진다",
      "모든 노드가 정확히 2개의 자식을 가져야 한다"
    ],
    "answer": 2,
    "brief": "마지막 레벨 빼고 꽉 참 + 마지막 레벨은 왼쪽부터 채움.",
    "detailed": "완전 이진 트리는 마지막 레벨을 제외하고는 모든 노드가 꽉 차 있고, 마지막 레벨은 왼쪽에서 오른쪽으로 차곡차곡 채워진다. ①은 포화 이진 트리, ②는 편향 트리 설명이다. 그래서 중간에 빈자리가 없어 배열 저장이 효율적이다.",
    "source": "10차시 슬라이드 3"
  },
  {
    "id": "DS_F5Q10",
    ...
    "detailed": "힙은 첨자 1부터 저장하므로 왼쪽 자식 2i, 오른쪽 자식 2i+1, 부모 ⌊i/2⌋(소수점 버림)이다. ①은 9차시의 0-인덱스 배열 트리 공식으로 혼동하면 안 된다.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "배열은 노드 삽입 시 메모리를 동적 할당하지 않아도 되어 트리 높이를 몰라도 되기 때문",
      "힙은 중간에 빈 노드가 없는 완전 이진 트리라 배열에 빈틈없이 담겨 인덱스 수식으로 부모·자식을 즉시 계산할 수 있기 때문"
    ],
    "answer": 3,
    "brief": "완전 이진 트리라 배열에 빈틈없이 담겨 인덱스 계산이 쉬움.",
    "detailed": "힙은 완전 이진 트리라 중간에 빈 노드가 없어 배열에 빈틈없이 저장되고, ⌊i/2⌋·2i·2i+1 수식만으로 부모·자식 위치를 즉시 계산한다. 편향 트리(①)나 포인터 사용(②)은 틀린 설명이다.",
    "source": "10차시 슬라이드 3"
  },
  {
    "id": "DS_F5Q12",
  ...
  },
  {
    ...
    "choices": [
      "항상 인접 행렬보다 메모리를 많이 쓴다",
      "N개의 연결 리스트 배열을 사용하며 각 정점에 인접한 정점들을 링크로 연결해 저장한다",
      "두 정점의 인접 여부를 O(1)에 즉시 확인할 수 있어 행렬보다 빠르다",
      "방향 그래프에는 사용할 수 없다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "basic",
    "question": "교수님이 기말고사 출제를 확정한 그래프 ADT 연산 adjacent(v)의 기능은?",
    "choices": [
      "그래프를 공백 상태로 초기화한다",
      "정점 v를 그래프에서 삭제한다",
    ...
    "detailed": "adjacent(v)는 정점 v에 인접한 정점들의 리스트를 반환하는 연산이다. 탐색 시 '다음에 어디로 갈지'를 결정하는 가장 필수적인 연산이라 교수님이 기말고사 출제를 확정했다.",
    "source": "11차시 슬라이드 21"
  },
  {
    "id": "DS_F5Q18",
  ...
  },
  {
    ...
    "choices": [
      ...
      "G'는 연결(connected) 그래프이다",
      "간선 수가 정점 수보다 1개 적다: |E(G')| = n + 1",
      "사이클(cycle)이 없다"
    ],
    "answer": 2,
    "brief": "신장트리 간선 수는 n-1이지 n+1이 아니다.",
    "detailed": "신장트리는 모든 정점을 포함(V(G')=V(G))하고 연결되어 있으며 간선 수가 정점 수보다 1개 적은 n-1개여야 한다. 간선이 n-1개이므로 사이클이 생기지 않는다. ③은 n+1로 틀렸다.",
    "source": "12차시 슬라이드 4"
  },
  {
    "id": "DS_F5Q20",
  ...
  },
  {
    ...
    "choices": [
      "가중치 합이 최대가 되는 신장트리이다",
      "간선을 n개 모두 포함하는 트리이다",
      "가중치가 부여된 그래프에서 n-1개 간선의 가중치 합이 최소가 되는 신장트리이며 Kruskal과 Prim으로 구한다",
      "정점 수와 무관하게 항상 단 하나만 존재한다"
    ],
    "answer": 2,
  ...
  },
  {
    ...
    "choices": [
      "모든 정점을 사이클 없이 잇는 문제",
      "가중치 합이 최대인 경로를 찾는 문제",
      "정점의 차수를 최대로 만드는 문제",
      "한 출발 정점에서 다른 정점(들)까지 가는 경로 중 간선 가중치의 합이 최소인 경로를 찾는 문제"
    ],
    "answer": 3,
    "brief": "출발점→목적지 가중치 합 최소 경로.",
    "detailed": "최단경로는 하나의 출발 정점에서 다른 정점까지 이르는 경로 중 간선 가중치(시간·비용·거리)의 합이 최소가 되는 경로를 찾는 문제다. 역 수만 따지면 모든 간선 가중치를 1로 두면 된다. ①은 (최소)신장트리 문제다.",
    "source": "12차시 슬라이드 19"
  },
  {
    "id": "DS_F5Q24",
  ...
  },
  {
    ...
    "choices": [
      "내부 정렬은 디스크 등 외부 기억장치를 사용한다",
      "외부 정렬은 데이터가 주기억장치 용량보다 작을 때 쓴다",
      "머지 정렬은 데이터가 커서 분할 정렬 후 합치는 외부 정렬에 주로 쓰인다",
      "퀵 정렬은 대표적인 외부 정렬이다"
    ],
    "answer": 2,
    "brief": "외부 정렬 대표 = 머지.",
  ...
  },
  {
    ...
    "choices": [
      "정렬된 그룹에 데이터를 하나씩 추가한다",
      "피벗을 기준으로 대상을 분할해 정복하는 분할 정복 방식이며 평균적으로 가장 빠르다",
      "비교를 하지 않고 버킷으로 분류한다",
      "입력과 무관하게 항상 O(N²)이다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "basic",
    "question": "힙(Heap)의 구조적 정의로 가장 정확한 것은? (교수님 출제 예고 포인트)",
    "choices": [
      "모든 노드가 두 자식을 갖는 포화 이진 트리",
      "부모가 자식보다 크거나 작은 완전 이진 트리(Complete Binary Tree)",
      "왼쪽 < 루트 < 오른쪽인 이진 탐색 트리(BST)",
      "차수가 일정한 일반 트리"
    ],
    "answer": 1,
    "brief": "힙 = 완전 이진 트리(+부모·자식 대소).",
    "detailed": "힙은 '부모 노드 값이 자식보다 크거나(Max) 작은(Min) 완전 이진 트리'다. 핵심은 반드시 완전 이진 트리라는 점(출제 예고)이며, BST(L<Root<R)와 혼동하면 안 된다.",
    "source": "13차시 §8 힙 정렬"
  }
];
...
export const set6 = [
  {
    ...
    "choices": [
      ...
      "모든 노드의 링크를 2개로 고정하고, 45도 회전하면 이진 트리로 변환된다",
      "일반 트리를 표현할 수 없고 이진 트리에만 쓰인다"
    ],
    "answer": 2,
  ...
  },
  {
    ...
    "choices": [
      "모든 레벨이 예외 없이 꽉 차 있어야 한다",
      "한쪽으로만 자식이 이어진 선형 구조이다",
      "자식 수가 항상 1개인 트리이다",
      "마지막 레벨을 제외하고 꽉 차 있으며, 마지막 레벨은 왼쪽부터 빈틈없이 채워진다"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "교수님이 '값이 작아서 왼쪽으로 가는 게 아니다'라고 강조한, 힙에 새 노드를 넣는 삽입 위치 규칙은?",
    "choices": [
      "새 값을 루트와 비교해 작으면 왼쪽 서브트리, 크면 오른쪽 서브트리로 내려간다",
      "값과 무관하게 마지막 레벨의 맨 왼쪽 빈자리부터(왼→오) 먼저 채운 뒤 부모와 비교해 위로 올린다",
      "항상 루트 자리에 먼저 넣고 자식과 비교해 아래로 내린다",
      "트리에서 가장 깊은 단말 노드의 왼쪽 자식 자리에 넣는다"
    ],
    "answer": 1,
    "brief": "자리부터(마지막 레벨 왼→오 빈자리) 채우고 Up-heap.",
    "detailed": "힙 삽입은 완전 이진 트리를 유지하려고 마지막 레벨 맨 오른쪽 다음 빈자리(왼→오)에 무조건 넣은 뒤, 부모와 비교해 크면 교환하며 위로 올린다(Up-heap). ①은 BST 삽입 방식이라 힙과 다르다.",
    "source": "10차시 슬라이드 5"
  },
  {
    "id": "DS_F6Q9",
    ...
    "choices": [
      "새 노드를 부모와 비교해 부모가 더 작으면 교환하고, 루트에 도달하거나 부모가 더 클 때까지 위로 반복한다",
      "새 노드를 자식과 비교해 더 큰 자식과 교환하며 아래로 내려간다",
      "새 노드를 넣은 뒤 트리 전체를 다시 정렬한다",
      "새 노드는 항상 한 번만 교환하면 힙 조건이 완성된다"
    ],
    "answer": 0,
    "brief": "부모와 비교, 부모가 작으면 교환하며 위로(Up-heap).",
    "detailed": "삽입은 새 노드와 부모를 비교해 부모가 작으면 교환하고, 루트에 닿거나 부모가 더 클 때까지 위로 올라간다. ②는 삭제 시의 Down-heap 설명이다. 한 번만 교환한다는 보장은 없다(④ 오답).",
    "source": "10차시 슬라이드 5"
  },
  {
    "id": "DS_F6Q10",
    ...
    "choices": [
      "마지막 노드를 루트에 올린 뒤, 왼·오 자식 중 더 큰 자식과 교환하며 자신보다 큰 자식이 없을 때까지 아래로 내려간다",
      "루트의 왼쪽 자식을 무조건 루트로 올린다",
      "마지막 노드를 루트에 올린 뒤, 더 작은 자식과 교환하며 내려간다",
      "트리를 중위 탐색하여 정렬된 순서로 다시 채운다"
    ],
    "answer": 0,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "슬라이드 예시에서 힙 [20(루트), 15, 2, 14, 10]의 루트 20을 삭제하고 재구성(Down-heap)했을 때, 새 루트와 그 두 자식은?",
    "choices": [
      "루트 14, 자식 15·2",
      "루트 10, 자식 15·2",
      "루트 2, 자식 15·14",
    ...
    "detailed": "20 삭제 후 마지막 노드 10을 루트로 올리면 [10,15,2,14]. 10의 자식 15·2 중 큰 15와 교환 → [15,10,2,14]. 다시 10이 자식 14보다 작아 교환 → 최종 루트 15, 자식 14·2, 14의 자식 10. 슬라이드 (c) 결과와 일치한다.",
    "source": "10차시 슬라이드 8"
  },
  {
    "id": "DS_F6Q12",
  ...
  },
  {
    ...
    "choices": [
      "스택을 쓴다. 후진을 해야 하기 때문이다",
      "큐(Queue)를 쓴다. 먼저 발견한(가까운) 정점을 먼저 방문해야 하므로 FIFO가 필요하다",
      "우선순위 큐를 쓴다. 가중치 순으로 방문하기 때문이다",
      "트리를 쓴다. 계층 구조를 저장하기 때문이다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "choices": [
      "방향 그래프에서는 차수를 정의할 수 없다",
      "차수는 항상 정점 수와 같다",
      "진입 차수(in-degree)는 정점으로 들어오는 간선 수, 진출 차수(out-degree)는 정점에서 나가는 간선 수다",
      "in-degree와 out-degree는 항상 같다"
    ],
    "answer": 2,
  ...
  },
  {
    ...
    "choices": [
      "모든 정점의 차수가 짝수이기만 하면 된다",
      "모든 정점이 연결되어 있고, 차수가 홀수인 정점이 2개 이하여야 한다",
      "간선 수가 정점 수보다 많아야 한다",
      "그래프가 방향 그래프여야 한다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "choices": [
      "무방향은 꺾쇠 <vi,vj>로 쓰고 (vi,vj)≠(vj,vi)이다",
      "둘 다 괄호 (vi,vj)로 쓰며 방향만 다르다",
      "방향 그래프는 항상 무방향 그래프보다 간선이 적다",
      "무방향은 괄호 (vi,vj)로 쓰고 (vi,vj)=(vj,vi)이며, 방향은 꺾쇠 <vi,vj>로 쓰고 <vi,vj>≠<vj,vi>이다"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "detailed": "완전 그래프는 가능한 최대 간선을 가진다. 무방향은 방향이 없어 중복 절반을 나눠 n(n-1)/2, 방향은 양방향을 모두 세어 n(n-1)이다. n=5면 각각 10, 20. 교수님 예시: 정점 3개면 무방향 최대 3개, 4개면 6개.",
    "source": "11차시 슬라이드 10"
  },
  {
    "id": "DS_F6Q18",
    ...
    "choices": [
      "정점 a와 간선 (a,b)가 서로 인접하다",
      "정점 a는 정점 b에 인접(adjacent)하고, 간선 (a,b)는 정점 a, b에 부속(incident)한다",
      "간선 (a,b)는 정점 a, b에 인접하고, 정점끼리는 부속한다",
      "인접과 부속은 같은 의미다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "정점이 4개인 완전 그래프가 가질 수 있는 신장트리의 개수는? (완전 그래프 정점 n개의 신장트리 수 = n^(n-2))",
    "choices": [
      "16개 (= 4^2)",
      "4개 (= 4^1)",
      "64개 (= 4^3)",
    ...
    "detailed": "정점이 n개인 완전 그래프의 신장트리 개수는 n^(n-2)개다(케일리 공식). n=4이면 4^(4-2) = 4^2 = 16개. 교수님이 슬라이드의 '개수는 많다'를 구체 수식 n^(n-2)로 강조했다.",
    "source": "12차시 슬라이드 7"
  },
  {
    "id": "DS_F6Q20",
    ...
    "choices": [
      "시작 정점에서 인접한 정점을 하나씩 트리에 추가한다",
      "모든 간선을 가중치 오름차순으로 정렬해 작은 것부터 택하되, 사이클을 만드는 간선은 버리고 n-1개가 될 때까지 반복한다",
      "가장 가중치가 큰 간선부터 선택한다",
      "정점을 무작위로 선택해 연결한다"
    ],
    "answer": 1,
    "brief": "간선 오름차순, 작은 것부터, 사이클이면 버림.",
    "detailed": "Kruskal은 간선 기반이다. 모든 간선을 가중치 오름차순 정렬 후 가장 작은 간선부터 택하고, 추가 시 사이클이 생기면 그 간선을 버린다(discard). 선택 간선이 n-1개가 될 때까지 반복한다. ①은 Prim이다.",
    "source": "12차시 슬라이드 11"
  },
  {
    "id": "DS_F6Q21",
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "교수님이 강조한, Kruskal·Prim에서 여러 간선의 가중치가 같을 때(동률)의 우선순위 규칙은?",
    "choices": [
      "알파벳이 앞서거나 숫자가 작은 정점을 연결하는 간선을 우선 선택한다",
      "알파벳이 뒤에 오거나 숫자가 큰 정점을 우선 선택한다",
      "동률이면 둘 다 동시에 선택한다",
      "동률이면 그 간선들을 모두 버린다"
    ],
    "answer": 0,
    "brief": "동률이면 알파벳 앞·작은 숫자 정점 우선.",
    "detailed": "교수님 팁: 가중치가 같을 경우 알파벳이 앞서거나 숫자가 작은 정점을 연결하는 간선을 우선적으로 선택한다. 답안의 일관성을 위한 디테일로, 이 우선순위를 놓치지 말라고 마무리에서 다시 강조했다.",
    "source": "12차시 슬라이드 11"
  },
  {
    "id": "DS_F6Q22",
    ...
    "choices": [
      "전체 간선을 정렬해 가중치가 작은 간선부터 무조건 추가한다",
      "가중치가 가장 큰 간선의 정점을 추가한다",
      "현재 트리 집합(TV) 안의 정점과 TV 밖의 정점을 잇는 간선 중 가중치가 가장 작은 간선의 정점을 TV에 추가한다",
      "도달 불가능한 정점부터 추가한다"
    ],
    "answer": 2,
    "brief": "TV 안↔밖 잇는 최소 간선 정점을 추가.",
    "detailed": "Prim은 정점 기반이다. 시작 정점을 TV에 넣고, u∈TV이고 v∉TV인 간선 (u,v) 중 가중치가 최소인 것을 골라 v를 TV에 추가한다. 이미 TV에 있는 정점은 다시 잇지 않아 사이클이 생기지 않는다. ①은 Kruskal이다.",
    "source": "12차시 슬라이드 15"
  },
  {
    "id": "DS_F6Q23",
    ...
    "choices": [
      "Kruskal은 정점 기반, Prim은 간선 기반이다",
      "Kruskal은 간선(Edge) 기반, Prim은 정점(Vertex) 기반이다",
      "둘 다 정점 기반이다",
      "둘 다 간선 기반이다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "한 학생이 'Kruskal/Prim이 매번 최소 간선만 고르는데 더 짧은 우회로가 있을 수 있지 않나요?'라고 질문했다. 교수님의 답변 요지로 옳은 것은?",
    "choices": [
      "두 알고리즘 모두 사이클을 막으면서 매 단계 Local Minimum을 택하므로, 전체 합이 최소인 Global Minimum(최소신장트리)이 수학적으로 보장된다",
      "운이 좋아야 최소신장트리가 나온다",
      "Kruskal만 보장되고 Prim은 보장되지 않는다",
      "정점 수가 적을 때만 보장된다"
    ],
    "answer": 0,
    "brief": "Local Min 선택 → Global Min 수학적 보장.",
    "detailed": "교수님 답변: 두 알고리즘 모두 사이클을 방지하면서 항상 현재 상황의 최소 가중치(Local Minimum)만 선택해 연결하므로, 궁극적으로 전체 가중치 합이 최소인 최소신장트리(Global Minimum)를 도출함이 수학적으로 보장된다(그리디 최적성).",
    "source": "12차시 슬라이드 10"
  },
  {
    "id": "DS_F6Q25",
  ...
  },
  {
    ...
    "choices": [
      "단계마다 Swap이 일어나 총 이동은 3(N−1)이고 불안정 정렬이다",
      "이동이 전혀 없고 안정 정렬이다",
      "총 이동은 N(N−1)/2이고 안정 정렬이다",
      "이동은 N번이고 불안정 정렬이다"
    ],
    "answer": 0,
    "brief": "이동 3(N−1), 불안정.",
  ...
  },
  {
    ...
    "choices": [
      "무조건 Swap(이동 3번)을 사용한다",
      "타겟을 빼두고 큰 값들을 한 칸씩 미는 Shift를 사용해 이동을 줄일 수 있다",
      "데이터를 전혀 이동하지 않는다",
      "항상 선택 정렬보다 이동이 많다"
    ],
    "answer": 1,
...
export const set7 = [
  {
    ...
    "choices": [
      "레벨 탐색 — 큐로 한 층씩 복사하기 때문",
      "중위 탐색 — 오름차순으로 복사되기 때문",
      "전위 탐색 — 루트를 먼저 비교하기 때문",
      "후위 탐색 — 왼쪽·오른쪽 서브트리를 먼저 복사한 뒤 루트를 생성·연결해야 하기 때문"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "choices": [
      ...
      "중위 탐색 순서상 바로 다음 노드(후속자, Successor)"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "choices": [
      "BST는 중위 탐색 시 오름차순 정렬이 되지만, 힙은 중위 탐색에 정렬 의미가 없다",
      "힙은 완전 이진 트리 형태를 강제하지만, BST는 모양 제약이 없어 편향될 수 있다",
      "최댓값/최솟값을 힙은 루트에서 O(1)에 얻지만, BST는 한쪽 끝까지 따라가야 한다",
      "BST와 힙 모두 '부모 ≥ 자식'이라는 동일한 키 규칙을 따른다"
    ],
    "answer": 3,
    "brief": "'부모 ≥ 자식'은 힙만의 규칙. 옳지 않음.",
    "detailed": "BST는 'L < Root < R'(좌우 구분) 규칙을, 힙은 '부모 ≥ 자식'(좌우 무관) 규칙을 따른다. 둘은 서로 다른 규칙이므로 ④ 가 틀린 설명이다. 나머지는 모두 옳다: BST 중위=정렬, 힙=완전 이진 트리 강제, 힙 루트=최값 O(1). (교수님이 '힙과 BST의 차이'를 기말 출제로 예고)",
  ...
  },
  {
    ...
    "detailed": "중위 탐색은 L→V→R이다. A에서 왼쪽 B를 먼저 처리: B의 왼쪽 D → B → 오른쪽 E = (D B E). 그다음 루트 A. 마지막으로 오른쪽 C: C의 왼쪽 F → C = (F C). 합치면 D B E A F C다. ① 은 전위(A B D E C F), ③ 은 후위(D E B F C A), ④ 는 레벨 순서다.",
  ...
  },
  {
    ...
    "choices": [
      "트리에서 가장 큰 값을 가진 노드",
      "항상 루트 노드",
      "왼쪽 서브트리의 최댓값(가장 오른쪽) 또는 오른쪽 서브트리의 최솟값(가장 왼쪽) 노드",
      "삭제 노드의 부모 노드"
    ],
    "answer": 2,
  ...
  },
  {
    ...
    "choices": [
      "항상 왼쪽 자식만 선택하고 temp.key <= heap[child].key면 break",
      "child<*n && heap[child].key < heap[child+1].key면 child++ 하고, temp.key >= heap[child].key면 break",
      "child<*n && heap[child].key > heap[child+1].key면 child++ 하고, temp.key < heap[child].key면 break",
      "오른쪽 자식만 선택하고 temp.key >= heap[child].key면 child *= 2"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "hard",
    "question": "교수님이 '기말에 둘이 어떻게 다른가를 묻는다'고 한 BST와 Heap의 비교로 옳지 않은 것은?",
    "choices": [
      "BST는 L<Root<R 규칙이고 중위 탐색하면 오름차순 정렬되지만, 힙은 형제 간 순서가 없어 중위 탐색이 정렬을 보장하지 않는다",
      "BST는 모양이 임의(편향 가능)지만, 힙은 완전 이진 트리가 강제된다",
      "최댓값을 찾을 때 Max Heap은 루트라서 O(1)이지만, BST는 맨 오른쪽까지 따라가야 한다",
      "BST와 힙 모두 자식이 항상 정확히 2개인 포화 이진 트리여야 한다"
    ],
    "answer": 3,
    "brief": "BST·힙 모두 포화 이진 트리 강제는 틀린 설명.",
    "detailed": "④가 틀렸다. BST는 모양 제약이 없고(편향 가능), 힙은 완전 이진 트리이지 포화 이진 트리가 아니다. 나머지(①②③)는 모두 옳은 BST vs Heap 비교다.",
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "hard",
    "question": "교수님이 기말 출제로 예고한 데이터 (21, 12, 33, 14, 25, 36, 7, 28, 39, 10)를 순서대로 삽입해 만든 Max Heap의 루트와 배열([1]~[10])로 옳은 것은?",
    "choices": [
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "hard",
    "question": "연습문제 Max Heap [39, 36, 33, 28, 14, 21, 7, 12, 25, 10]에서 루트를 한 번 삭제하고 재구성한 결과 배열([1]~[9])은?",
    "choices": [
  ...
  },
  {
    ...
    "detailed": "후위 탐색(L-R-V)은 자식들을 모두 방문한 뒤 루트를 마지막에 방문하므로 루트 21이 맨 끝에 온다: 10, 7, 14, 12, 28, 25, 39, 36, 33, 21. ②는 중위, ③은 전위 결과이며 ④는 단순 내림차순으로 오답이다.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "DFS와 BFS 모두 트리의 후위 탐색에 대응한다",
      "DFS는 트리의 전위 탐색(preorder), BFS는 트리의 레벨 탐색(level order)에 대응한다"
    ],
    "answer": 3,
    "brief": "DFS=전위, BFS=레벨.",
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "DFS/BFS에서 방문할 수 있는 인접 정점이 여러 개일 때 공통으로 적용하는 방문 순서 원칙은? (교수님이 BFS 트레이싱 중 강조한 함정 포인트)",
    "choices": [
      "정점 번호가 큰 것부터 방문한다",
      "가중치가 큰 간선부터 방문한다",
    ...
    "answer": 2,
    "brief": "작은 번호부터 먼저 방문.",
    "detailed": "갈 수 있는 인접 정점이 여러 개면 정점 번호가 작은 것부터 먼저 방문한다. 교수님이 BFS 라이브 트레이싱 중 큐 삽입 순서가 꼬여 '큐에는 무조건 작은 숫자를 먼저 넣는다'고 정정했고, 이는 시험 함정으로 좋은 포인트라 백지에 큐를 그려가며 트레이싱하라고 권했다.",
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "정점이 10개인 연결 그래프에서 DFS로 모든 정점을 방문하며 지나간 간선이 9개(n-1개)였다. 교수님이 이로부터 강조한 결론은?",
    "choices": [
      "지나간 간선만 남기면 사이클 없이 모든 정점을 연결하는 신장 트리(Spanning Tree)가 된다",
      "그래프에 사이클이 반드시 존재한다",
      "그래프가 완전 그래프임을 뜻한다",
      "DFS가 잘못 수행되었다는 신호다"
    ],
    ...
    "detailed": "모든 정점을 방문하면서 거친 간선이 n-1개(여기선 9개)면 사이클이 없고 모든 정점이 연결된 트리가 된다. 교수님은 'DFS/BFS를 통해 신장 트리(Spanning Tree)를 구할 수 있다'고 강조했다. 신장 트리는 기말 출제 예고 개념이다.",
    "source": "11차시 슬라이드 24-26"
  },
  {
    "id": "DS_F7Q16",
    ...
    "choices": [
      "출력은 한 줄이고 연결 요소는 1개다",
      "출력은 2줄이고 연결 요소는 2개다(0 1 2 3 / 4 5 6 7)",
      "출력은 8줄이고 연결 요소는 8개다",
      "dfs가 호출되지 않아 아무것도 출력되지 않는다"
    ],
    "answer": 1,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "교수님이 별표를 치며 기말 출제를 예고한 다음 차시(그래프 II) 개념과 설명으로 옳지 않은 것은?",
    "choices": [
      "신장 트리(Spanning Tree): 한 정점에서 퍼져 나가 모든 정점을 연결하는 사이클 없는 트리",
      "최소 신장 트리(MST): 간선 가중치의 합이 최소가 되는 신장 트리",
      "최단 경로(Shortest Path): 한 시작 정점에서 다른 모든 정점에 이르는 가장 비용이 적은 경로",
      "추이적 폐쇄(Transitive Closure): 두 정점 사이 간선이 하나만 존재하도록 제한하는 단순 그래프 규칙"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "choices": [
      ...
      "출발점과 같은 값이 된다",
      "가장 작은 값으로 갱신된다",
      "어떤 정점을 거쳐도 도달할 수 없으므로 끝까지 무한대(강의 표현 1000)로 남는다"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "hard",
    "question": "슬라이드의 Kruskal 예에서 간선이 (0,5)10, (2,3)12, (1,6)14, (1,2)16 순으로 선택된 뒤 (3,6)18 차례가 되었다. 이 (3,6) 간선의 처리로 옳은 것은?",
    "choices": [
      "가중치가 가장 작으므로 무조건 선택한다",
      "정점 6이 새 정점이므로 선택한다",
      "시작 간선이 아니므로 무시한다",
      "이미 선택된 간선들로 3과 6이 연결되어 사이클이 생기므로 버린다(discard)"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "answer": 3,
    "brief": "④ 틀림 — 실수·문자는 불가.",
    "detailed": "기수 정렬은 비교 없이 자리수 기준으로 버킷(큐)에 분배·수집하며 O(d·N)(d=최대 자리수)이다. 그러나 실수·한글·한자 등에는 적용할 수 없고, 동일한 길이의 숫자나 단순 알파벳에만 쓸 수 있다. 따라서 ④가 옳지 않다.",
  ...
  },
  {
    ...
    "choices": [
      "Low가 가리키는 값과 피벗을 교환한다",
      "High가 가리키는 값과 피벗을 교환해 피벗 위치를 확정한다",
      "분할을 중단하고 전체를 처음부터 다시 시작한다",
      "피벗을 무조건 리스트 맨 뒤로 보낸다"
    ],
    "answer": 1,
    "brief": "엇갈리면 High값 ↔ 피벗.",
  ...
  },
  {
    ...
    "choices": [
      "빈 루트에 마지막 노드를 올린 뒤, 더 큰 자식과 비교하며 아래로 내려 힙을 재구성한다",
      "빈 루트에 가장 작은 값을 새로 삽입한다",
      "전체 트리를 처음부터 다시 만든다",
      "빈 루트를 그대로 두고 다음 삭제로 넘어간다"
    ],
    "answer": 0,
...
export const set8 = [
  ...
  },
  {
    ...
    "choices": [
      "우선순위 큐는 FIFO 순서로만 동작하므로 힙과 무관하다",
      "우선순위 큐는 스택(LIFO)으로만 구현된다",
      "우선순위 큐는 BST의 중위 탐색으로 구현하는 것이 표준이다",
      "우선순위가 가장 높은(값이 큰) 원소를 먼저 처리할 때 Max Heap이 잘 맞고, 가장 낮은 것부터면 Min Heap을 쓴다"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "choices": [
      "vi에서 vj로 가는 경로만 존재하면 된다",
      "두 정점이 간선으로 직접 인접해 있다",
      "같은 가중치를 가진 간선으로 이어져 있다",
      "vi에서 vj로 가는 경로와 vj에서 vi로 가는 경로가 모두 존재한다(상호 도달)"
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "type": "multiple_choice",
    "difficulty": "medium",
    "question": "교수님이 강조한 Dijkstra 알고리즘의 핵심 키포인트는?",
    "choices": [
      "항상 간선 수가 가장 적은 경로만 택한다",
      "항상 직접(바로) 가는 경로만 택한다",
      "돌아가더라도(우회하더라도) 가중치의 합이 더 작으면 우회 경로를 택한다",
      "가중치가 가장 큰 경로를 택한다"
    ],
    "answer": 2,
    "brief": "우회해도 합이 작으면 우회 선택.",
    "detailed": "교수님 키포인트: 돌아가더라도 가중치의 합이 작으면 우회 경로를 선택한다. 즉 바로 가는 distance와 특정 정점 u를 경유한 distance 합 중 더 작은(Minimum) 값으로 거리를 갱신한다(Relaxation).",

...
export const set2 = [
  ...
  },
  {
    ...
    type: "short_answer",
    difficulty: "hard",
    question: "이진 Naive Bayes 분류기에서 $P(y=1) = P(y=0) = 0.5$, 조건부 확률이 $P(x_1=1 \\mid y=1) = 0.8$, $P(x_1=1 \\mid y=0) = 0.4$, $P(x_2=1 \\mid y=1) = 0.5$, $P(x_2=1 \\mid y=0) = 0.2$ 이다. 새 샘플 $x_1=1, x_2=1$에 대해 Naive Bayes 가정으로 계산한 두 클래스의 점수 비율 ($y=1$ 점수 ÷ $y=0$ 점수)은? (소수점 첫째 자리까지, 예: 5.0)",
    answer: "5.0",
    answer_type: "number",
    tolerance: 0.05,
  ...
  },
  {
    ...
    type: "short_answer",
    difficulty: "hard",
    question: "SVM에서 가중치 $w = (3, 4)$, 편향 $b = 2$ 이고, 데이터 포인트 $x = (1, 1)$의 실제 라벨이 $y = +1$이다. 이 샘플의 **Functional Margin** $\\hat{\\gamma}$ 값을 계산하시오. (정수 또는 소수점 첫째 자리까지)",
    answer: "9",
    answer_type: "number",
    tolerance: 0.05,
